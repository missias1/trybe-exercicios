...
const orderModifier = (order) => {
  ...
  let comprador = order.order.delivery.deliveryPerson = "Luiz Silva";
...
console.log(`Olá ${comprador}, o total do seu pedido de ${Object.keys(order.order.pizza)} e ${Object.values(order.order.drinks.coke)[0]} é R$ ${order.payment.total}.`)
}
